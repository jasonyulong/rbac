...
<div class="tag-content">
    <form action="<?php echo url('/v1/auth/position/add'); ?>" class="form-horizontal dialog-form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control selectpicker show-tick" data-live-search="true" title="" id="pid" name="pid"  data-msg-required="请选择">
                            ...
                            <?php if(is_array($positionArr) || $positionArr instanceof \think\Collection || $positionArr instanceof \think\Paginator): $i = 0; $__LIST__ = $positionArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control selectpicker show-tick" title="请选择" id="user_id" name="user_id[]"  data-live-search="true" multiple="multiple" data-actions-box="true">
                            ...
                            <?php if(in_array($key,$bindUserId)): ?>disabled="disabled"<?php endif; ?>
                            ><?php echo $vo; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-4 control-label "><span class="red-color">自动获取所有帐号可见权限：</span></label>
                    <div class="col-sm-8">
                        <?php echo build_radios('auto_account', ['0' => '否', '1' => '是'], 0); ?>
                    </div>
                </div>
            </div>
        </div>
