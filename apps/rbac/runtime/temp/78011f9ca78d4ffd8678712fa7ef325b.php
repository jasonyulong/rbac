...
<div class="dialog-content">
    <form action="<?php echo url('/v1/users/index/edit',array('addType'=>'add')); ?>" class="form-horizontal dialog-form"
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="selectpicker show-tick form-control" title="请选择部门" id="org_id" name="org_id"
                            ...
                            <option value="<?php echo $orgList['id']; ?>" <?php if(($orgList['rid']-$orgList['lid'] !=1)): ?>disabled="disabled"<?php endif; ?>><?php echo $orgList['title']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="position" name="position" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" title="请选择角色" id="job_type" name="job_type"
                            ...
                            <option value="<?php echo $ruleId; ?>"><?php echo $ruleName; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" title="" id="ready_computer" name="ready_computer">
                            ...
                            <option value="<?php echo $readyId; ?>"><?php echo $readyName; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
