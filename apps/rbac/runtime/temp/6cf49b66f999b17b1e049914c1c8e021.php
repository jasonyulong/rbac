<?php if (!defined('THINK_PATH')) exit(); /*a:11:{s:74:"/opt/web/zs/apps/rbac/public/../application/v1/view/users/index/offer.html";i:1555559559;s:61:"/opt/web/zs/apps/rbac/application/v1/view/layout/default.html";i:1554986348;s:58:"/opt/web/zs/apps/rbac/application/v1/view/common/meta.html";i:1553692263;s:60:"/opt/web/zs/apps/rbac/application/v1/view/common/header.html";i:1556509685;s:57:"/opt/web/zs/apps/rbac/application/v1/view/common/map.html";i:1554891314;s:71:"/opt/web/zs/apps/rbac/application/v1/view/users/index/_offersearch.html";i:1555148965;s:67:"/opt/web/zs/apps/rbac/application/v1/view/users/index/_navtabs.html";i:1556599567;s:70:"/opt/web/zs/apps/rbac/application/v1/view/users/index/_offertable.html";i:1556509685;s:62:"/opt/web/zs/apps/rbac/application/v1/view/common/template.html";i:1553692263;s:60:"/opt/web/zs/apps/rbac/application/v1/view/common/script.html";i:1553692263;s:61:"/opt/web/zs/apps/rbac/application/v1/view/common/require.html";i:1553692263;}*/ ?>
<!DOCTYPE html>
...
<div class="content">
    ...
    <tr>
        ...
        <td class="td-align td-padding"><?php echo $val['id']; ?></td>
        <td class="td-align td-padding"><?php echo $val['username']; ?></td>
        <td class="td-align td-padding"><?php echo $val['email']; ?><br><?php echo $val['mobile']; ?></td>
        ...
        <td class="td-align td-padding"><?php echo $pact_type[$val['pact_type']]; ?></td>
        <td class="td-align td-padding"><?php echo $ready_computer[$val['ready_computer']]; ?></td>
        <td class="td-align td-padding"><?php echo $room[$val['room']]; ?></td>
        <td class="td-align td-padding"><?php echo $val['createuser']; ?></td>
        <td class="td-align td-paddingtd-padding">
            <div class="div-wid">
                <div>创建时间:<?php echo $val['createtime']; ?></div>
