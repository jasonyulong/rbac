...
<div class="dialog-content">
    <form action="<?php echo url('/v1/auth/position/copy'); ?>" class="form-horizontal dialog-form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}">
        <div class="row">
            <div class="col-md-9">
