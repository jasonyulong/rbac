...
<div class="container-fluid">
    <br>
    <form action="<?php echo url('/v1/group/department/cat'); ?>" class="form-horizontal" method="post">
        <input type="hidden" name="id" value="<?php echo $params['id']; ?>">
        <div class="row">
            <div class="col-md-9">
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm"  name="user_name" value="<?php echo $params['user_name']; ?>" placeholder="请输入姓名">
                    </div>
    ...
    <div class="btn-group batch-bottom">
        ...
        <ul class="dropdown-menu">
            <li><a href="javascript:;" class="batch_forbid" data-url="<?php echo url('/v1/group/organization/forbid'); ?>"><i class="glyphicon glyphicon-remove"></i> 批量禁用</a></li>
        </ul>
    </div>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td class="td-align"><?php echo $vo['user_name']; ?></td>
            <td class="td-align">
                <?php if($vo['status'] == 1): ?>
            ...
            <td class="td-align">
                ...
                <button type="button" class="btn btn-danger btn-sm btn-padding forbid"
                        data-url="<?php echo url('/v1/group/organization/forbid'); ?>" data-id="<?php echo $vo['id']; ?>"><i
