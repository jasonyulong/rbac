...
<div class="tag-content">
    <form action="<?php echo url('/v1/auth/tag/edit'); ?>" class="form-horizontal dialog-form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="name" name="name" value="<?php echo $info['name']; ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control form-control-sm" id="desc" name="desc" value="<?php echo $info['desc']; ?>" rows="8"
                                  data-rule="required;name;" data-msg-required="请填写标签描述"><?php echo $info['desc']; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
