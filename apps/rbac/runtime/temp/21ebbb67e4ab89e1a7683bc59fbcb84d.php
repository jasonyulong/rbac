...
<div class="content">
        ...
        <div class="form-group margin-t">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="savePending" href="javascript:void(0)" data-url="<?php echo url('/v1/users/index/pending',array('statusValue'=>3)); ?>">批量转离职</a></li>
                </ul>
            </div>
        </div>
    ...
    <tr>
        ...
        <td class="td-align td-padding"><?php echo isset($getUserObj[$val['job_id']])?$getUserObj[$val['job_id']]: ''; ?></td>
        <td class="td-align td-padding"><?php echo isset($val['rules_id'])?$val['rules_id']: ''; ?></td>
        <td class="td-align td-padding"><?php echo isset($val['allow'])?$val['allow']: ''; ?></td>
        <td class="td-align td-padding">
            <?php echo user_online_html($val['token']); ?>
        </td>
        <td class="td-align td-padding">
            <?php echo $val['maturitytime']; ?><br>
            <?php echo $val['maturityuser']; ?>
        </td>
        <td class="td-align td-paddingtd-padding">
            <?php echo $val['logintime']; ?>
            <br>
            <div class="shouIp" data-id="<?php echo $val['id']; ?>" data-url=""><?php echo isset($val['loginip'])?$val['loginip']: ''; ?></div>
        </td>
    </tr>
    <?php endforeach; ?>
    </tbody>
