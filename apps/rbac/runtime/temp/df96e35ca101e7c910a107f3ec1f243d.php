...
<div class="dialog-content">
    <form action="<?php echo url('/v1/group/department/add'); ?>" class="form-horizontal dialog-form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}">
        <div class="row">
            <div class="col-md-9">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="pid" name="pid"  data-msg-required="请选择">
                            ...
                            <?php if(is_array($organization) || $organization instanceof \think\Collection || $organization instanceof \think\Paginator): $i = 0; $__LIST__ = $organization;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <?php if(in_array($vo['id'],$depUser)): ?>disabled="true"<?php else: ?>class="dep-option"<?php endif; ?>>
