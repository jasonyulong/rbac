...
<div class="dialog-content">
    <form action="<?php echo url('/v1/auth/position/edit'); ?>" class="form-horizontal dialog-form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" title="" id="pid" name="pid"  data-msg-required="请选择">
                            ...
                            <?php if(in_array($vo['id'],$idArr)): ?>disabled="true"<?php endif; if($info['pid'] == $vo['id']): ?>selected="selected"<?php endif; ?>
