...
<div class="container-fluid">
    <br>
    <form action="<?php echo url('/v1/auth/position/cat'); ?>" class="form-horizontal" method="post">
    ...
    <div class="btn-group batch-bottom">
        ...
        <ul class="dropdown-menu">
            <!--物流操作-->
            <li><a href="javascript:;" class="batch_move" data-url="<?php echo url('/v1/auth/position/move'); ?>"><i class="glyphicon glyphicon-remove"></i> 批量移除</a></li>
        </ul>
    </div>
            ...
            <tr>
                ...
                <td class="td-align td-padding">
                    <button type="button" class="btn btn-danger btn-xs move"
                            data-url="<?php echo url('/v1/auth/position/move',array('ids'=>$vo['id'])); ?>"><i
