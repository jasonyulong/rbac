...
<html>
    ...
    <body>
        ...
        <div class="system-message {$codeText}">
            <div class="image">
                <img src="__CDN__/dist/img/{$codeText}.svg" alt="" width="150" />
            </div>
            <h1>{$msg}</h1>
            {if $wait > 0}
            <p class="jump">
            ...
            <p class="clearfix">
                <a href="javascript:history.go(-1);" class="btn btn-grey">{:__('点击返回')}</a>
                <a href="{$url}" class="btn btn-primary">{:__('点击跳转')}</a>
            </p>
            {/if}
        </div>
